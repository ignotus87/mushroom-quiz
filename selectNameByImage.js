        ...
        createApp({
            ...
            methods: {
                ...
                getPuzzleImageUrls() {
                    ...
                    for (let pi = 0; pi < this.puzzleItems.length; ++pi) {
                        for (let i = 0; i < this.puzzleItems[pi].ImageSource.length; ++i) {
                            urls.push("/SpeciesImages/" + this.puzzleItems[pi].ID + (i === 0 ? "" : "_" + (i + 1).toString()) + ".jpg");
                        }
                    }
                ...
                cacheImages() {
                    var urls = this.getPuzzleImageUrls();
